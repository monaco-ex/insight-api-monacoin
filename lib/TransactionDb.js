...
var encodedData = require('soop').load('monacore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('monacore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('monacore/lib/Address', {
